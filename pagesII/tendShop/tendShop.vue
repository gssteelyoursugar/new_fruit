	...
	<view class="container">
		...
		<form @submit="postsaveStores" @reset="formReset">
			...
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" class="tui-input" name="merchantsName" :placeholder="merchantsName" maxlength="30" type="text" />
				</view>
			</tui-list-cell>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
			...
			<tui-list-cell :arrow="true"  :lineLeft="false" shape="circle"   >
				<view class="tui-line-cell2">
					<view class="tui-title2" >
						...
						<input placeholder-class="tui-phcolor" class="tui-input" name="address" :placeholder="text1" maxlength="50" type="text"  disabled="flase"/>
						</view>
				</view>
			</tui-list-cell>
			</picker>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" class="tui-input" name="address2" :placeholder="addressDetails" maxlength="50" type="text" />
				</view>
			</tui-list-cell>
		...
		<view class="tui-box tui-order-box">
			...
			<view class="tui-order-list">
				<view class="tui-order-list">
					<view class="tui-order-item" v-for="(item,index) in imgDataLi" :key="index" @click="uploadImages(index)">
...
<script>
	import {publicing,publicing2,listing} from '../../api/api.js'
	import {postSaveStore,uploading,uploadFiles,getClient,loginis,postAddressList} from '../../api/request.js'
