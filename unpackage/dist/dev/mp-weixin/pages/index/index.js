...
var components = {
  ...
  lygPopup: function() {
    return __webpack_require__.e(/*! import() | components/lyg-popup/lyg-popup */ "components/lyg-popup/lyg-popup").then(__webpack_require__.bind(null, /*! @/components/lyg-popup/lyg-popup.vue */ 404))
  }
}
var render = function() {
  var _vm = this
    ...
    getIndexClass: function getIndexClass() {var _this5 = this;
      ...
      then(function (res) {
        ...
        for (var index in goodsData) {
          goodsData[index].praiseNumber = _this5.numConvert(goodsData[index].praiseNumber);
        }
